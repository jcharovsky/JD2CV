...
SOURCE = Path(os.environ.get("CV_SOURCE", ROOT / "ATS_CV_Template_es.md"))
OUTPUT = Path(os.environ.get("CV_OUTPUT", str(Path.home() / ".codex" / "tmp" / "jd2cv" / "ATS_CV_Template_es.pdf")))
...
def build():
    ...
    doc = BaseDocTemplate(
        ...
        title="Plantilla de CV ATS",
        author="JD2CV",
        subject="CV compatible con ATS",
    )
